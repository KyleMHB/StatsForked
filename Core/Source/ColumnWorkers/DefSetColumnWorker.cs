...
public abstract class DefSetColumnWorker<TObject> : DefSetColumnWorker<TObject, DefSetTableCell>
{
    protected override DefSetTableCell RefreshCell(DefSetTableCell cell, out bool wasStale)
    {
        wasStale = false;
        return cell;
    }
