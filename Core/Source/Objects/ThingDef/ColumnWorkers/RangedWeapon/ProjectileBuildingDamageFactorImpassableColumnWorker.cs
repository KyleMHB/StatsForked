...
public sealed class ProjectileBuildingDamageFactorImpassableColumnWorker :
    ...
    IColumnWorker<TurretDef>
{
    ...
    public ProjectileBuildingDamageFactorImpassableColumnWorker(ColumnDef columnDef)
    {
        ColumnDef = columnDef;
    }
