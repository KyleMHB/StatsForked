...
public sealed class Thing_LabelColumnWorker : ColumnWorker, IColumnWorker<VirtualThing>, IColumnWorker<Thing>
{
    ...
    IEnumerable<ObjectTableWidget.ColumnPart> IColumnWorker<Thing>.GetObjectProps()
    {
        throw new NotImplementedException();
    }
