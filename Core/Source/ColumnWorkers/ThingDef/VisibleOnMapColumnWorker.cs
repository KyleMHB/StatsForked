...
public sealed class VisibleOnMapColumnWorker(ColumnDef columnDef) : ColumnWorker<DefBasedObject, VisibleOnMapColumnWorker.LiveBooleanCell>
{
    ...
    {
        bool value = InventoryStateTracker.IsVisibleOnPlayerMap(cell.ThingDef);
